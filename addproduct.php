...
if(empty($barcode)){
  ...
  $insert=$pdo->prepare("insert into tbl_product (product,category,description,stock,purchaseprice,saleprice,supplier,image)values(:product,:category,:description,:stock,:pprice,:saleprice,:supplier,:img)");
...
$insert=$pdo->prepare("insert into tbl_product (barcode,product,category,description,stock,purchaseprice,saleprice,supplier, image)values(:barcode,:product,:category,:description,:stock,:pprice,:saleprice,:supplier,:img)");
...
<div class="col-lg-6">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
      <select class="form-control" name="txtsupplier" required>
