...
$select = $pdo->prepare("SELECT * FROM tbl_product WHERE pid = ?");
$select->execute([$id]); // Bind parameter using an array
    ...
    if (!empty($f_name)) {
        ...
        if ($f_extension == 'jpg' || $f_extension == 'jpeg' || $f_extension == 'png' || $f_extension == 'gif') {
            if ($f_size >= 1000000) {
                ...
                $_SESSION['status'] = "1mb is maximum file";
                ...
                if (move_uploaded_file($f_tmp, $store)) {
                    ...
                    if ($update->execute()) {
                        ...
                        $_SESSION['status'] = "Product & Image Updated";
                        $_SESSION['status_code'] = "success";
                    } else {
                      
                        $_SESSION['status'] = "Product Failed to Update";
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txtselect_option" required>
                                                ...
                                                while($row=$select->fetch(PDO::FETCH_ASSOC))
                                                {
                                                    extract($row);
                                                ?>
                                                    <option <?php if($row['category']== $category_db ){ echo "selected"; } ?>><?php echo $row['category'];?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Description" name="txtdescription" rows="4" required><?php echo $description_db;?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" step="any" class="form-control" value="<?php echo $purchaseprice_db;?>" placeholder="Enter Purchase Price" name="txtpurchaseprice" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Sale Price</label>
                                            <input type="number" min="1" step="any" class="form-control" value="<?php echo $saleprice_db;?>" placeholder="Enter Sale Price" name="txtsaleprice" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Product Image</label><br />
                                            <img src="productimages/<?php echo $image_db;?>" class="img-rounded" width="60px" height="60px/">
                                            <br /><br />
